        ...
        <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
              ...
              <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
                <div class="space-y-6 overflow-hidden rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <div class="mt-6 flex items-center gap-2.5">
                    ...
                    <button
                      type="button"
                      class="inline-flex w-full items-center justify-center rounded-lg bg-third-700 px-5 py-2.5 text-sm font-medium  text-white hover:bg-third-800 focus:outline-none focus:ring-4 focus:ring-third-300 dark:bg-third-600 dark:hover:bg-third-700 dark:focus:ring-third-800"
                    >
                      <svg
          ...
          <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
            <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              ...
              <a
                href="#"
                class="flex w-full items-center justify-center rounded-lg bg-third-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-third-800 focus:outline-none focus:ring-4 focus:ring-third-300 dark:bg-third-600 dark:hover:bg-third-700 dark:focus:ring-third-800"
              >
                Proceed to Checkout
              </a>
              ...
              <div class="flex items-center justify-center gap-2">
                ...
                <a
                  href="#"
                  title=""
                  class="inline-flex items-center gap-2 text-sm font-medium text-third-700 underline hover:no-underline dark:text-third-500"
                >
                  Continue Shopping
                  <svg
                    class="h-5 w-5"
              ...
              <form class="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="voucher"
                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-third-500 focus:ring-third-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-third-500 dark:focus:ring-third-500"
                    placeholder=""
                    required
                  />
                </div>
